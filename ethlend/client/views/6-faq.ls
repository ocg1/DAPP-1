...
template \faq -> main_blaze div style:'padding-top:50px; width:672px;' class:\container,
    ...
    p img class:\faq-img src:\faq/image1.jpeg width:\642 height:\252, "MetaMask window will popup. Accept the transaction. 0.01 ETH platform fee is deducted."
    p img class:\faq-img src:\faq/image2.jpeg width:\642 height:\281
    p "The transaction is complete and the new loan request is created."
    p img class:\faq-img src:\faq/image3.jpeg width:\642 height:\253
    p "Find your loan request by pressing All Loan Requests from the menu. Ethereum might take a while to load."
    p img class:\faq-img src:\faq/image4.jpeg width:\642 height:\254
    ...
    p img class:\faq-img src:\faq/image5.jpeg width:\642 height:\250
    p "Your new loan request is loaded from the Ethereum Blockchain. Might take a while to load."
    p img class:\faq-img src:\faq/image6.jpeg width:\642 height:\253
    ...
    p img class:\faq-img src:\faq/image7.jpeg width:\642 height:\326
    p "Below is a sample loan data."
    p img class:\faq-img src:\faq/image8.jpg width:\642 height:\430
    p "After you submitted the data, accept the transaction with MetaMask (should pop up)."
    p img class:\faq-img src:\faq/image9.jpg width:\642 height:\335
    p "Below message should appear on successful data."
    p img class:\faq-img src:\faq/image10.jpeg width:\642 height:\328
    ...
    p img class:\faq-img src:\faq/image11.jpg width:\642 height:\418
    ...
    p img class:\faq-img src:\faq/image12.jpeg width:\642 height:\315
    ...
    p img class:\faq-img src:\faq/image13.jpg width:\642 height:\334
    p "You should see the following window on success."
    p img class:\faq-img src:\faq/image14.jpeg width:\642 height:\327
    ...
    p img class:\faq-img src:\faq/image15.jpg width:\642 height:\408
    ...
    p img class:\faq-img src:\faq/image16.jpeg width:\642 height:\227
    p "When you click the loan, it might take a while that the loan is rendered from the Ethereum Blockchain."
    p img class:\faq-img src:\faq/image17.jpeg width:\642 height:\260
    ...
    p img class:\faq-img src:\faq/image18.jpg width:\642 height:\413
    ...
    p img class:\faq-img src:\faq/image19.jpg width:\642 height:\336
    p "When you see something that corresponds below, you have successfully borrowed Ethers"
    p img class:\faq-img src:\faq/image20.jpeg width:\642 height:\275
    ...
    p img class:\faq-img src:\faq/image21.jpeg width:\642 height:\223
    ...
    p img class:\faq-img src:\faq/image22.jpg width:\642 height:\423
    ...
    p img class:\faq-img src:\faq/image23.jpg width:\642 height:\410
    ...
    p img class:\faq-img src:\faq/image24.jpg width:\642 height:\330
    p "The loan is paid back and the tokens are transferred to your account. Whoa!"
    p img class:\faq-img src:\faq/image25.jpeg width:\642 height:\255
    ...
    p img class:\faq-img src:\faq/image26.jpg width:\642 height:\419
    ...
    p img class:\faq-img src:\faq/image27.jpg width:\642 height:\417
    p "MetaMask pops up. Accept the transaction."
    p img class:\faq-img src:\faq/image28.jpg width:\642 height:\380
    p "Now the tokens are transferred to your wallet."
    p img class:\faq-img src:\faq/image29.jpeg width:\642 height:\229
    ...
    p img class:\faq-img src:\faq/image30.jpg width:\642 height:\408
    ...
    p img class:\faq-img src:\faq/image31.jpeg width:\642 height:\147
